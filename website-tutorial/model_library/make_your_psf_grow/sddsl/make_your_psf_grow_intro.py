...
# description: Introduction to the case study of a professional services firm that has to grow - the assumptions it rests on and how the four parts build on each other.
...
app = marimo.App(app_title="Case Study: Make Your Professional Service Firm Grow (SD DSL)")
