...
class simulation_model():
    def __init__(self):
        ...
        'projectDeliveryCapacity'      : lambda t: 160.0,
        ...
        self.converters = ['cashFlow',   'collectionTime',   'cost',   'overheadCost',   'projectDeliveryCapacity',   'projectDeliveryFee',   'projectDeliveryRate',   'revenue',   'staffCost',   'staffSalary',   'workplaceCost'  ]
        self.gf = []
        self.constants= []
        self.events = [
            ]
