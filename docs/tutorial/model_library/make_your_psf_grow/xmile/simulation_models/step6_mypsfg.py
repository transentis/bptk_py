...
class simulation_model():
    def __init__(self):
        ...
        self.points = {
            'businessDevelopmentAllocation%' :  [(0.0, 20.0), (1.0, 20.0), (2.0, 20.0), (3.0, 20.0), (4.0, 20.0), (5.0, 20.0), (6.0, 20.0), (7.0, 20.0), (8.0, 20.0), (9.0, 20.0), (10.0, 20.0), (11.0, 20.0), (12.0, 20.0), (13.0, 20.0), (14.0, 20.0), (15.0, 20.0), (16.0, 20.0), (17.0, 20.0), (18.0, 20.0), (19.0, 20.0), (20.0, 20.0), (21.0, 20.0), (22.0, 20.0), (23.0, 20.0), (24.0, 20.0)]  , 
        }
        ...
        self.stocks = ['cash',   'professionalStaff',   'projects',   'proposals',   'receivables'  ]
        self.flows = ['cashIn',   'cashOut',   'collectingRevenue',   'deliveringProjects',   'makingRevenue',   'prospectingProjects',   'winningProjects'  ]
        self.converters = ['businessDevelopmentCapacity',   'cashFlow',   'collectionTime',   'cost',   'overheadCost',   'projectAcquisitionDuration',   'projectDeliveryCapacity',   'projectDeliveryFee',   'projectDeliveryRate',   'projectProposalRate',   'projectVolume',   'prospectingEffort',   'revenue',   'staffCost',   'staffSalary',   'workCapacity',   'workMonth',   'workplaceCost'  ]
        self.gf = ['businessDevelopmentAllocation%'  ]
        self.constants= []
        self.events = [
            ]
