...
class simulation_model():
    def __init__(self):
        ...
        'expectedProfitability'          : lambda t: ( (100.0) if ( t  <=  self.starttime ) else (self.memoize('expectedProfitability',t-self.dt) + self.dt * ( self.memoize('changeInExpectedProfitability',t-self.dt) )) ),
        ...
        # Flows
        'changeInExpectedPrice'             : lambda t: ( self.memoize('indicatedPrice', t) - self.memoize('expectedPrice', t) ) / self.memoize('priceAdjustmentTime', t),
        'changeInExpectedProfitability'             : lambda t: ( self.memoize('profit', t) - self.memoize('expectedProfitability', t) ) / self.memoize('profitAdjustmentTime', t),
        ...
        'productionRate'             : lambda t: max([0 , min([self.memoize('production', t) , self.delay( self.memoize('productionStartRate', ( t - (self.memoize('productionTime', t)) )),self.memoize('productionTime', t),100.0,t)])]),
        ...
        'capacityCostPerUnit'      : lambda t: self.memoize('capacityCost', t) / self.memoize('productionRate', t),
        'capacityUtilization'      : lambda t: self.memoize('effectOfProfitabilityOnCapacityUtilization', t),
        'cost'      : lambda t: self.memoize('variableCost', t) + self.memoize('capacityCost', t),
        ...
        'minimumPrice'      : lambda t: self.memoize('unitVariableCost', t) + self.memoize('capacityCostPerUnit', t),
        'normalizedExpectedProfitability'      : lambda t: self.memoize('expectedProfitability', t) / self.memoize('referenceExpectedProfitability', t),
        'normalizedPerceiedInventoryCoverage'      : lambda t: self.memoize('perceivedInventoryCoverage', t) / self.memoize('referenceInventoryCoverage', t),
        ...
        'profit'      : lambda t: self.memoize('revenue', t) - self.memoize('cost', t),
        'profitAdjustmentTime'      : lambda t: 12.0,
        'referenceDemand'      : lambda t: 100.0 + self.memoize('marketShockOn', t) * (0 if t < 10.0 else self.memoize('sizeOfShock', t)),
        ...
        'sizeOfShock'      : lambda t: 50.0,
        'unitCapacityCost'      : lambda t: 0.5,
        'unitVariableCost'      : lambda t: 1.0,
        'variableCost'      : lambda t: self.memoize('unitVariableCost', t) * self.memoize('productionRate', t),
        
    
        # gf
        'effectOfInventoryCoverageOnPrice' : lambda t: LERP( self.memoize('normalizedPerceiedInventoryCoverage', t), self.points['effectOfInventoryCoverageOnPrice']),
        'effectOfProfitabilityOnCapacityUtilization' : lambda t: LERP( self.memoize('normalizedExpectedProfitability', t), self.points['effectOfProfitabilityOnCapacityUtilization']),
        ...
        self.points = {
            'effectOfInventoryCoverageOnPrice' :  [(0.0, 1.404), (0.16666666666666666, 1.415), (0.3333333333333333, 1.404), (0.5, 1.372), (0.6666666666666666, 1.351), (0.8333333333333334, 1.277), (1.0, 1.0), (1.1666666666666667, 0.787), (1.3333333333333333, 0.55), (1.5, 0.4), (1.6666666666666667, 0.34), (1.8333333333333333, 0.298), (2.0, 0.298)]  , 'effectOfProfitabilityOnCapacityUtilization' :  [(0.0, 0.324), (0.16666666666666666, 0.33), (0.3333333333333333, 0.372), (0.5, 0.394), (0.6666666666666666, 0.41), (0.8333333333333334, 0.42), (1.0, 0.5), (1.1666666666666667, 0.745), (1.3333333333333333, 0.80075), (1.5, 0.8565), (1.6666666666666667, 0.91225), (1.8333333333333333, 0.968), (2.0, 0.968)]  , 'effectOfRelativeValueOnDemand' :  [(0.0, 0.17), (0.16666666666666666, 0.191), (0.3333333333333333, 0.213), (0.5, 0.277), (0.6666666666666666, 0.351), (0.8333333333333334, 0.479), (1.0, 1.0), (1.1666666666666667, 1.362), (1.3333333333333333, 1.479), (1.5, 1.574), (1.6666666666666667, 1.638), (1.8333333333333333, 1.66), (2.0, 1.66)]  , 
        }
        ...
        self.stocks = ['expectedPrice',   'expectedProfitability',   'inventory',   'perceivedInventoryCoverage',   'production',   'productionCapacity'  ]
        self.flows = ['changeInExpectedPrice',   'changeInExpectedProfitability',   'changeInPerceivedInventoryCoverage',   'consumptionRate',   'productionRate',   'productionStartRate'  ]
        self.converters = ['capacityCost',   'capacityCostPerUnit',   'capacityUtilization',   'cost',   'demand',   'indicatedPrice',   'inventoryCoverage',   'inventoryCoveragePerceptionTime',   'marketShockOn',   'minimumPrice',   'normalizedExpectedProfitability',   'normalizedPerceiedInventoryCoverage',   'price',   'priceAdjustmentTime',   'priceOfSubstitutes',   'productionTime',   'profit',   'profitAdjustmentTime',   'referenceDemand',   'referenceExpectedProfitability',   'referenceInventoryCoverage',   'relativeValueOfProduct',   'revenue',   'sizeOfShock',   'unitCapacityCost',   'unitVariableCost',   'variableCost'  ]
