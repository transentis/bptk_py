...
class simulation_model():
    def __init__(self):
        ...
        'initialOpenTasks'      : lambda t: 120.0,
        ...
        self.points = {
            'productivity' :  [(0.0, 0.4), (0.25, 0.444), (0.5, 0.506), (0.75, 0.594), (1.0, 1.0), (1.25, 1.119), (1.5, 1.1625), (1.75, 1.2125), (2.0, 1.2375), (2.25, 1.245), (2.5, 1.25)]  , 
        }
