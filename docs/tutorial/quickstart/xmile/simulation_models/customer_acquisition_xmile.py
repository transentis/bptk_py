...
class simulation_model():
    def __init__(self):
        ...
        # Flows
        'customerAcquisition'             : lambda t: max([0 , self.memoize('acquisitionThroughAdvertising', t) + self.memoize('acquisitionThroughWordOfMouth', t)]),
        
    
        # converters
        'acquisitionThroughAdvertising'      : lambda t: self.memoize('consumersReachedThroughAdvertising', t) * self.memoize('advertisingSuccess', t),
        'acquisitionThroughWordOfMouth'      : lambda t: self.memoize('consumersReachedThroughWordOfMouth', t) * self.memoize('wordOfMouthSuccess', t) * ( 1.0 - self.memoize('marketSaturation', t) ),
        'advertisingBudget'      : lambda t: 100.0,
        'advertisingSuccess'      : lambda t: 0.1,
        'consumersReachedPerEuro'      : lambda t: 100.0,
        'consumersReachedThroughAdvertising'      : lambda t: self.memoize('consumersReachedPerEuro', t) * self.memoize('advertisingBudget', t) * ( 1.0 - self.memoize('marketSaturation', t) ),
