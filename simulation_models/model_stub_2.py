...
class simulation_model():
    ...
    def __init__(self):
        ...
        self.equations = {
            ...
            'customers2': lambda t: self.memoize('initialCustomers', t) if t == 0 else self.equations['customers2'](t - dt) + dt * self.memoize('acquisitionRate',t - dt),
            ...
            'totalCustomersReachedThroughWordOfMouth': lambda t: self.memoize('customers2', t) * self.memoize(
                'wordOfMouthContactRate', t),

            'totalMarket': lambda t: self.memoize('customers2', t) + self.memoize('potentialCustomers', t),
        ...
        self.stocks = ['customers2', 'potentialCustomers', 'totalAcquisitonsThroughMarketing',
