...
class modelMonitor():
    ...
    def __init__(self, source_file, dest, update_func, itmx=True):
        ...
        log("[INFO] Model Monitor: Starting to Monitor {} for changes. Will transform itmx file to Python model whenever I observe changes to it! Destination file: {}".format(source_file, dest))
