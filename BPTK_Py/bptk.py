...
class bptk():
    ...
    def export_scenarios(
        ...
        if scenarios is None:
            scenarios = []
        manager = self.scenario_manager_factory.get_scenario_managers(scenario_managers_to_filter=[scenario_manager])[
        scenario_manager]
